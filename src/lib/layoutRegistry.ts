...
export const layouts: LayoutInfo[] = [
  ...
  { id: 'statHighlight', name: 'Stat Highlight', description: 'Headline numbers — the most legible layout.', category: 'Project' },
  { id: 'dataModel', name: 'Data Model', description: 'Entities, relationships, and the rules between them.', category: 'Architecture' },
  { id: 'stateMachine', name: 'State Machine', description: 'States and the transitions between them.', category: 'Architecture' },
  { id: 'sequence', name: 'Sequence', description: 'Two-party choreography over time.', category: 'Architecture' },
  { id: 'calendarHeat', name: 'Calendar Heat', description: 'A run of days and the streak it produces.', category: 'Project' },
  { id: 'hierarchyProgress', name: 'Hierarchy Progress', description: 'Nested progress bars that roll upward.', category: 'Project' },
  { id: 'fanOut', name: 'Fan Out', description: 'One input, many sources, one merged result.', category: 'Architecture' },
